// TAKEN FROM:
// https://github.com/kumardeo/deox/blob/main/packages/drizzle-d1-utils/src/index.ts

// BASED ON DISCUSSIONF FROM HERE (code created on Jun27/2025):
// https://github.com/drizzle-team/drizzle-orm/discussions/1545
// NOTE: need to have `pnpm add -D @libsql/client` run
// - script:    "db:studio": "drizzle-kit studio",
// - script:    "db:studio:prod": "REMOTE=1 drizzle-kit studio"
